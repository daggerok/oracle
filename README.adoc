...
_required running oracle in docker, sqlplus installed and bash / cygwin shell_

.try prepared sample for 1) create tablespace and user; 2) create needed schema:
[sources,bash]
----
